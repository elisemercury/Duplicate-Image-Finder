...
The difPy Web App is based on :ref:`difPy`, a `Python-based package`_ that automates the **search for duplicate/similar images**.

.. _Python-based package: https://github.com/elisemercury/Duplicate-Image-Finder
